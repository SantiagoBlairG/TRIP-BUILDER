...
Warm off-white canvas, charcoal text, forest-green primary controls, quiet borders, and generous whitespace. Geist is the interface font; Instrument Serif is reserved for editorial headlines. Both use `next/font`.
...
- Button: default, outline, and ghost variants; default, small, and icon sizes. Radix Slot supports links without nesting interactive elements.
